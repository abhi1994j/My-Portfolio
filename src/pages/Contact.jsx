      ...
      <section className="w-full px-4 py-15 bg-gray-50">
        <div className="w-full flex justify-center items-center">
          <div className="flex flex-col space-y-4 items-center mb-5 w-full max-w-lg sm:max-w-xl md:max-w-4xl">
            <h1 className="text-2xl text-center md:text-3xl lg:text-4xl font-semibold" data-aos="fade-down">
              Get In Touch
            </h1>
            <div className="h-1 rounded-lg w-20 bg-black inline-block" data-aos="fade-up"></div>
            <div className="w-full max-wmd sm:max-w-lg md:max-w-2xl" data-aos="fade-up">
        ...
        <div className="space-y-6" data-aos="fade-up">
          <h1 className="text-2xl font-semibold" data-aos="fade-right">Contact Information</h1>
          ...
          <div className="flex items-center gap-4" data-aos="zoom-in">
            ...
            <div>
              ...
              <p className="text-gray-500 hover:text-gray-900 cursor-pointer">
                abhibaban4@gmail.com
              </p>
            </div>
          </div>

          <div className="flex items-center gap-4" data-aos="zoom-in" data-aos-delay="100">
            <span className="bg-gray-200 text-center rounded-full">
          ...
          <h1 className="text-2xl font-semibold" data-aos="fade-right" data-aos-delay="300">Follow Me</h1>
          <p data-aos="fade-up" data-aos-delay="400">
            Connect with me on social media to stay updated with my latest
            projects and activities.
          </p>

          <div className="flex gap-2" data-aos="fade-up" data-aos-delay="500">
            <NavLink
              target="blank"
