...
const About = () => {
  const skills = ["Java" , "Javascript" , "TypeScript" , "React" , "Next.js" , "Node.js" , "Express" , "MongoDB" , "SQL" , "HTML/CSS" , "Tailwind CSS" , "Bootstrap" , "Git" , "Postman" , "Docker" , "AWS" , "REST API" , "Postman"]
